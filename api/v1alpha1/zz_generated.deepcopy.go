...
func (in *APIConditionPolicy) DeepCopyInto(out *APIConditionPolicy) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new APIConditionPolicy.
func (in *APIConditionPolicy) DeepCopy() *APIConditionPolicy {
	if in == nil {
		return nil
	}
	out := new(APIConditionPolicy)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DurationPolicy) DeepCopyInto(out *DurationPolicy) {
	*out = *in
	...
	if in.APICondition != nil {
		in, out := &in.APICondition, &out.APICondition
		*out = new(APIConditionPolicy)
		**out = **in
	}
}
